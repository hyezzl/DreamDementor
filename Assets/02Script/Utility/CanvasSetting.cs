...
{
    //[Header("개발 해상도")]
    //[SerializeField] private Vector2 tempResolution = new Vector2(640, 360);  // UI디자인 기준 해상도 (referenceResolution)

    [Header("런타임 해상도")]
    [SerializeField] private Vector2 resolution = new Vector2(1920, 1080);    // 게임 실행 해상도 (SetResolution)
    ...
    private void Awake()
    {
        ...
        else
        {
            ...
            scaler.matchWidthOrHeight = 0.5f; // 가로/세로 중간값을 혼합해서 맞춤
        }
    }
